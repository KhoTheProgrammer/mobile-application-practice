...
import com.example.myapplication.data.repository.DonationStatus
import com.example.myapplication.data.repository.DonorSummary
    ...
    private fun applyFilter(filter: DonationFilterType) {
        val filtered = when (filter) {
            ...
            DonationFilterType.MONETARY -> uiState.donations.filter { 
                it.donationType == com.example.myapplication.data.repository.DonationType.MONETARY 
            }
            DonationFilterType.IN_KIND -> uiState.donations.filter { 
                it.donationType == com.example.myapplication.data.repository.DonationType.IN_KIND 
            }
        }
